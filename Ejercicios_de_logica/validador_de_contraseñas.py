...
palabras_no_admitidas = contraseña.count ("abc")
palabras_no_admitidas2 = contraseña.count ("123")
...
elif palabras_no_admitidas > 0 and palabras_no_admitidas2 > 0:
...
#Falta corregir algo en el elif de la linea 30 no tiene que permitir palabras con "abc" ni "123"